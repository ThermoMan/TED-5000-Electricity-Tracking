...
<html>
  ...
  <body>
	...
	<div class='all_tabs'>
		...
		<div class='tab' id='chart2'> <a href='#chart2'> kW per Minute </a>
			<div class='container'>
				<div class='tab-toolbar'>
					<p>&nbsp;</p>
				</div>
		...
		<div class='tab' id='chart3'> <a href='#chart3'> kW per Min </a>
			<div class='container'>
				<div class='tab-toolbar'>
					<p>&nbsp;</p>
				</div>
				<div class='content'>
					<div class='electric_chart'>
						<iframe id='frame3' src='elec_chart.php?show_chart=3' style='border:0px'></iframe>
					</div>
...
?>
					<p>You must enter password to access config information.  For the test system, the password is &quot;<?php echo $password ?>&quot;.</p>
<?php
}
}
?>
